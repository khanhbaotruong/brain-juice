#define BLYNK_TEMPLATE_ID "TMPLJloT86PU"
#define BLYNK_DEVICE_NAME "nhiptimspo22"
#define BLYNK_AUTH_TOKEN "m6Vk7n3CYQCwr1QKBUybPY075_GDXEZC"
...
void sendSensor()
{
 BPM = pox.getHeartRate();
  ...
  {
    Serial.println("Failed to read from Max30100 sensor!");
  }
